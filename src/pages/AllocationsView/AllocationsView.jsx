...
const AllocationsView = ({ setNavbar }) => {
  ...
  useEffect(() => {
    console.log("Lecturers:", selectedLecturers);
    console.log("second examiner:", selectedSecondExaminer);
    console.log("demontrators:", selectedDemonstrators);
  }, [selectedLecturers, selectedSecondExaminer, selectedDemonstrators]);
  return (
